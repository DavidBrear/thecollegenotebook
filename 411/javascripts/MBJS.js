...
//function openQuestion is the function that will open the main question mark box when clicked. This box will serve to answer questions about each page
function openQuestion()
{
	document.getElementById('questionBox').style.top = '0px';
	document.getElementById('questionBox').style.left = window.outerWidth - 50 + 'px';
}
...
document.onmousemove = function (evt)
{
	...
	{
		if(document.getElementById('IDbox').style != 'undefined')
		{
