...
<link rel="stylesheet" type="text/css" href="include/intro.css" media="all">
	...
	<div id="leftCol">
		<div id="loginbox">
			...
			<table id="loginform">
				...
				<tr>
					<td colspan="2"><div id="submitButton"><a href="registerpage">Register</a><br /><a href="forgotPassword">Forgot Password</a></td><td align="center"><input class="loginbutton" type="image" src="/images/submit.png"></td><td></td>
				</tr>
	...
	<div id="rightCol">
		<div id="schoolsearchbox">
			...
			<br>
			<a href="schoolindex" color="black">View All Schools</a>
			</form>
		</div>
